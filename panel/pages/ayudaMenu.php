                            ...
                            <div class="col-lg-12 col-md-9">
                                <div class="card">
                                    <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#previous-months" role="tab" aria-controls="pills-setting" aria-selected="false">Cerrar Sesión</a>
                                        </li>
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <!--tab Ayuda-->
                                        <div class="tab-pane fade" id="previous-months" role="tabpanel" aria-labelledby="pills-setting-tab">
                                            <div class="card-body">
                                            <div class="profiletimeline mt-0">
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="../img/portfolio-1.jpg" alt="user" class="rounded-circle" /> </div>
