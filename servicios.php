						...
						<div class="col-md-4">
							...
							<div class="icon-box circled icon-box-color__primary">
								...
								<div class="icon-box-body">
									...
									Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam laoreet sodales lacinia consectetur.
								</div>
							</div>
							<!-- Icon Box -->
						</div>
						...
						<div class="col-md-4">
							<div class="testimonial">
								...
								<div class="bq-author">
									...
									<h6>Elizabeth McDoe</h6>
									<span class="bq-author-info">Proin gravida nibh vel</span>
								</div>
							</div>
						</div>
						<div class="col-md-4">
